...
export const getCheckoutSession = async (req, res) => {
  try {
    ...
    let imageUrl;
    if (astrologer.photo && astrologer.photo.trim() !== "") {
      // If your images are stored in /uploads inside backend
      imageUrl = `${process.env.BACKEND_URL}/${astrologer.photo}`;
    } else {
      // Fallback default image
      imageUrl = "https://your-domain.com/default-avatar.jpg";
    }
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              ...
              images: imageUrl ? [imageUrl] : undefined // ✅ Only add if valid
            }
          },
          quantity: 1
        }
